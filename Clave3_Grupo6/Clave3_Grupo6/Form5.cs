    ...
    public partial class formTransporte : Form
    {
        ...
        private void BtnActualizar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                sql = "SELECT salarioBase, renta, seguroPensionesEmpleado, seguroSocial, horasExtra, bonoHorasExtra FROM gerencia_transporte WHERE id='" + id + "'";
                MySqlCommand comando = new MySqlCommand(sql, conexionBD);
                ...
                if (TxtSalario.Text != string.Empty)
                {
                    ...
                    sql = "UPDATE gerencia_transporte SET salarioBase='" + salarioBase + "', bonoHorasExtra='" + resultadoBonoHorasExtra + "' , renta='" + resultadoRenta + "', seguroPensionesEmpleado='" + resultadoPensionEmpleado + "', seguroPensionesEmpleador='" + resultadoPensionEmpleador + "', seguroSocial='" + resultadoSeguro + "', salarioNeto ='" + salarioNeto + "' WHERE id='" + id + "'";
                ...
                if (txtHorasExtra.Text != string.Empty)
                {
                    ...
                    sql = "UPDATE gerencia_transporte SET horasExtra='" + horasExtra + "', bonoHorasExtra='" + resultadoBonoHorasExtra + "', salarioNeto ='" + salarioNeto + "' WHERE id='" + id + "'";
        ...
        private void BtnMostrar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                sql = "SELECT COUNT(id) FROM gerencia_transporte";
                MySqlCommand comando = new MySqlCommand(sql, conexionBD);
                ...
                while (id <= i)
                {
                    conexionBD.Open();
                    //Recuperando campos de la base de datos
                    sql = "SELECT salarioBase, renta, seguroPensionesEmpleado, seguroSocial, horasExtra, bonoHorasExtra, seguroPensionesEmpleador, nombre, cargo, salarioNeto FROM gerencia_transporte WHERE id='" + id + "'";
